...
public class YoutubeMusicPlayActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
...
//        adView.loadAd(adRequest);
    ...
    private void DialogSimple() {
        ...
        alt_bld.setMessage("YouTube플레이어 초기화에 실패하였습니다." + "YouTube 앱이 설치되어 있지 않을 가능성이 있습니다. YouTube앱을 다운하시겠습니까?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
